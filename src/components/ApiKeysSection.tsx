      ...
      {revealedKey && (
        <div className="mb-4 p-4 bg-cyan-950 border border-cyan-700 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 text-sm font-mono text-cyan-300 break-all bg-[#0a0a0f] px-3 py-2 rounded">
              {revealedKey}
            </code>
            <button
              onClick={copyKey}
              className="shrink-0 px-3 py-2 text-xs bg-cyan-400 text-gray-950 rounded font-semibold hover:bg-cyan-300 transition-colors cursor-pointer"
            >
              {copied ? "Copied!" : "Copy"}
            </button>
          </div>
